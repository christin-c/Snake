...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int UNIT_SIZE = 25; // size of a body part
    static final int GAME_UNITS = (SCREEN_WIDTH * SCREEN_HEIGHT) / UNIT_SIZE; // 24 boxes per line
        ...
        public void keyPressed(KeyEvent e) {
            switch (e.getKeyCode()) {
                case KeyEvent.VK_LEFT:
                    // only allow the snake to move 90 degrees, you can't go from left to right directly
                    if (direction != 'R') {
                        direction = 'L';
                    }
                    break;
